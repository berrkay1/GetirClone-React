  ...
  return (
    <div className='relative before:bg-gradient-to-r before:from-[#5D3EBC] before:to-transparent before:absolute before:top-0 before:left-0 before:z-20 before:w-full before:h-full h-auto md:h-[500px] z-0 md:w-full '  >
      ...
      {windowWidth > 768 && <Slider {...settings}>
        <div>
          <img className='w-full h-[500px] object-cover' src="https://cdn.getir.com/getirweb-images/common/hero-posters/water-1.jpg" alt="" />
        </div>


      </Slider>}
      <div className='h-16 bg-[#5D3EBC] md:hidden  text-lg  font-bold relative z-50 top-0 left-0 flex items-center justify-center'>
        <span className='text-yellow-400'>getir<span className='text-white'>su</span> </span>
      </div>
...
export default GetirSuHeaderSection